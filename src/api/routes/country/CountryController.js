  ...
  class UserController {
    async create(req, res, next) {
      let { name} = req.body;
      try {
        var newRecord = new Country(req.body);
        ...
        return newRecord
          .save()
          .then((results) => {
            return res.success(results, req.__("Country_CREATE_SUCCESSFULLY"));
          })
          .catch((err) => {
      ...
      asyncParallel(
        {
          ...
          records_filtered: function(callback) {
            Country.countDocuments(conditions, (err, result) => {
              /* send success response */
              callback(err, result);
            });
          },
          records_total: function(callback) {
            Country.countDocuments({ is_deleted: 0 }, (err, result) => {
              /* send success response */
              callback(err, result);
            });
          },
        ...
        function(err, results) {
          ...
          return res.success(data, req.__("Country_LIST_GENREATED"));
        }
      );
    }
    ...
    async detail(req, res, next) {
      ...
      try {
        ...
        if (data == null) return res.notFound({}, req.__("Country_NOT_EXIST"));
  
        return res.success(data, req.__("Country_DETAIL_SUCCESSFULLY"));
      } catch (err) {
        return res.json({ data: err });
      }
    }
    ...
    async delete(req, res, next) {
      ...
      try {
        ...
        return res.success(data, req.__("Country_DELETE_SUCCESSFULLY"));
      } catch (err) {
        return res.json({ data: err });
      }
    }
    ...
    async UpdateStatus(req, res, next) {
      ...
      try {
        ...
        let updatedData = await Country.updateOne(
          {
            _id: req.params._id,
          },
          {
        ...
        return res.success(data, req.__("Country_STATUS_UPDATE_SUCCESSFULLY"));
      } catch (err) {
    ...
    async update(req, res, next) {
      ...
      try {
        ...
        await Country.findOneAndUpdate({ _id: req.params._id }, { ...data });
  
        return res.success(data, req.__("Country_UPDATE_SUCCESSFULLY"));
      } catch (err) {
        return res.json({ data: err });
      }
    }
    ...
    async dropdown(req, res, next) {
      ...
      asyncParallel(
        ...
        function(err, results) {
          ...
          return res.success(data, req.__("Country_LIST_DONE"));
        }
      );
    }
  
//   async getAdminSetting(req, res) {
//     let adminSetting = await Country.findOne();
//     const userJson = {};
//     if (adminSetting) {
